...
// data "oci_core_virtual_networks" "hub_vcn" {
//   compartment_id = var.compartment_ocid
// }
...
resource "oci_core_subnet" "mgmt_subnet" {
  ...
  security_list_ids   = [oci_core_virtual_network.hub_vcn.default_security_list_id, oci_core_security_list.mgmt_security_list.id]
...
resource "oci_core_subnet" "trust_subnet" {
  ...
  security_list_ids          = [oci_core_virtual_network.hub_vcn.default_security_list_id, oci_core_security_list.trust_security_list.id]
  dhcp_options_id            = oci_core_virtual_network.hub_vcn.default_dhcp_options_id
  dns_label                  = "trust"
...
resource "oci_core_subnet" "untrust_subnet" {
  ...
  security_list_ids   = [oci_core_virtual_network.hub_vcn.default_security_list_id, oci_core_security_list.untrust-security_list.id]
  dhcp_options_id     = oci_core_virtual_network.hub_vcn.default_dhcp_options_id
  dns_label           = "untrust"
}
...
resource "oci_core_subnet" "hb_subnet" {
  ...
  security_list_ids          = [oci_core_virtual_network.hub_vcn.default_security_list_id, oci_core_security_list.hb_security_list.id]
  dhcp_options_id            = oci_core_virtual_network.hub_vcn.default_dhcp_options_id
  dns_label                  = "hb"
  prohibit_public_ip_on_vnic = "true"
}
